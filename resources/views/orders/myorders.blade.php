    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="card p-3 bg-white"><i class="fa fa-apple"></i>
                ...
                <div class="d-flex justify-content-between total font-weight-bold mt-4"><span>Orders </span><span>{{$car->orders->count()}} </span></div>

                <a href="/orders/show/{{$car->id}}"  class="btn btn-success" style="margin: 10px">View Bookings </a>
